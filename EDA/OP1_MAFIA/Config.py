...
class Config:
    """ Mission setup. """
    __mission_date = "2022-12-06_2022-12-07"  # needs to have one day ahead.
    __wind_dir = "East"
    ...
    """ Operational Area. """
    __polygon_operational_area = pd.read_csv("csv/polygon.csv").to_numpy()
...
if __name__ == "__main__":
    ...
    plg = s.get_polygon_operational_area()
