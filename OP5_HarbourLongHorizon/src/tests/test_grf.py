...
def plotf_vector(x, y, values, title=None, alpha=None, cmap=get_cmap("BrBG", 10),
    ...
    """
    plt.scatter(x, y, c=values, s=200, cmap=get_cmap("BrBG", 10), vmin=vmin, vmax=vmax)
    plt.colorbar()
...
class TestGRF(TestCase):
    ...
    def test_prior_matern_covariance(self):
        print("S1")
        plotf(self, v1=self.g.get_mu(), v2 = np.diag(self.g.get_Sigma()), vmin1=None, vmax1=None,
