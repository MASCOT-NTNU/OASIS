...
#TODO:
# - Change from GMRF to GRF
# - Integrate changable threshold
# -


from Planner.Planner import Planner
from WaypointGraph import WaypointGraph
from BoundaryDetector import GradientDetection
from GRF2D import GRF
from WGS import WGS
...
class Myopic2D(Planner):
    ...
    def __init__(self) -> None:
        ...
        self.grf = GRF()
        self.boundary = GradientDetection()
