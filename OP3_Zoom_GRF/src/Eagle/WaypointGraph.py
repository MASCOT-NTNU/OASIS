...
class WaypointGraph:
    def __init__(self):
        ...
        self.__polygon_border = self.__field.get_polygon_border()
        self.__polygon_border_shapely = self.__field.get_polygon_border_shapely()
        self.__neighbour_hash_table = dict()
        self.__depths = self.__field.get_depth_layers()
        self.__construct_waypoints()
        self.__construct_neighbour_hash_table()
    ...
    def __construct_neighbour_hash_table(self) -> None:
