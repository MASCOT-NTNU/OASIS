...
class WaypointGraph:
    ...
    __neighbour_distance = 120  # metres between neighbouring locations.
    ...
    __depths = np.array([-0.5, -1, -1.5, -2, -2.5])
    __no_depth_layers = len(__depths)
    ...
    def construct_waypoints() -> None:
        ...
        if WaypointGraph.__no_depth_layers > 1:
            WaypointGraph.multiple_depth_layer = True
        for i in range(WaypointGraph.__no_depth_layers):
    ...
    @staticmethod
    def construct_hash_neighbours() -> None:
        ...
        for i in range(WaypointGraph.no_waypoint):
            ...
            ind_u = ind_d + 1 if ind_d < WaypointGraph.__no_depth_layers - 1 else ind_d
            ...
            WaypointGraph.__neighbour_hash_table[i] = ind_n
    ...
    def get_neighbour_hash_table():
        ...
        """
        return WaypointGraph.__neighbour_hash_table
    ...
    def get_neighbour_indices(ind: int) -> list:
        ...
        """
        return WaypointGraph.__neighbour_hash_table[ind]
